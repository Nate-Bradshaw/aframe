...
the folder "aframe" and respository is placed in C:\xampp\htdocs\aframe\
...
Other images are sceenshots of the game produced by ourselves.


game.html contains all of the a-frame entities and their attached components and their values. These entities are split into 3 sepperate parent entities which act as scene containers for a main menu, game and results scene. There are also some entites that are global to all these scenes, such as the camera, floor, skybox and veiw reset circle.
